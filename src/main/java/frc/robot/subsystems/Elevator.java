...
public class Elevator extends SubsystemBase{
    ...
    public Elevator() {
        //m_motorL.restoreFactoryDefaults(false);
    ...
    public void periodic() {
       ...
       SmartDashboard.putNumber("Ele Desired Velocity", state.velocity);
       SmartDashboard.putNumber("Ele Desired Pose", state.position);
       SmartDashboard.putNumber("Ele Actual Velocity", m_encoder.getVelocity());
        SmartDashboard.putNumber("Ele Actual Pose", m_encoder.getPosition());
        SmartDashboard.putNumber("Elevator Right Encoder", m_encoderR.getPosition());
