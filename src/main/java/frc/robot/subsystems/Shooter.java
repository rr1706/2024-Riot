...
public class Shooter extends SubsystemBase {
    ...
    //private final CANSparkMax m_motor2 = new CANSparkMax(8, MotorType.kBrushless);
    ...
    public Shooter() {
       ...
       // m_motor2.restoreFactoryDefaults(false);
        ...
        m_motor1.getConfigurator().apply(new CurrentLimitsConfigs().withStatorCurrentLimit(CurrentLimit.kShooter));
        m_motor2.getConfigurator().apply(new CurrentLimitsConfigs().withStatorCurrentLimit(CurrentLimit.kShooter));
